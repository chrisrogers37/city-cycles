...
| **02A: Weather Frontend Core** | Next.js app, CSS weather effects, data sections, responsive layout | **M** | IN PROGRESS |
| **02B: Weather Canvas Particles** | Canvas particle system: rain, snow, lightning | **S** | Blocked by 02A |
